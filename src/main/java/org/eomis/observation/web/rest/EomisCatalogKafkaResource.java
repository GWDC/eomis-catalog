...
@RestController
@RequestMapping("/api/eomis-catalog-kafka")
public class EomisCatalogKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EomisCatalogKafkaResource.class);
    ...
    public EomisCatalogKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
